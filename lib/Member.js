...
var Member = api.Member.extend({
    ...
    constructor: function(cfg, chain) {
        ...
        this._keyValStore = chain.getKeyValStore();
        this._keyValStoreName = toKeyValStoreName(this._name);
    ...
    isRegistered: function() {
        return this._enrollmentSecret !== undefined;
    },
     ...
     */
    isEnrolled: function() {
        return this._enrollment !== undefined;
    },
    ...
    .then(
    	function (tcerts) {
	        ...
	        while (self.getTCertWaiters.length > 0 && self.tcerts.length > 0) {
	            ...
	            waiter.resolve(self.tcerts.shift());
	        }
	    },
	    function(err) {
